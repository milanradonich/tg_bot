...
#
#
# async def add_user(chat_id: int, username: str, full_name: str) -> None:
#     """
...
#     : return : None
#     """
#     connection = sqlite3.connect("tg_bot/database/history.sqlite3")
...
#     try:
#         cursor.execute(
#             "INSERT INTO query(user_id, input_city, photo_need, destination_id) VALUES (?, ?, ?, ?)",
#             (user_id, query_data['city'], query_data['need_photo'], query_data['destinationId'])
#         )
#         logger.info('Добавлен в БД новый запрос.')запрос
#
...
#
#
# async def add_response(search_result: dict) -> None:
#     """
#     Создаёт таблицу, если она ещё не создавалась и добавляет туда данные,
